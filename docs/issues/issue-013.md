...
head:
  ...
  - - meta
    - property: og:image
      content: https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=1600&q=80
  - - meta
    - property: og:url
...
![黄昏下的太阳能板阵列](https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=1600&q=80)

封面图：黄昏下的太阳能板阵列。它很适合做这一期的隐喻：AI 最后不是飘在云里的“智能感”，而是要落在真实世界的电力、土地、资本开支和建设周期上。
