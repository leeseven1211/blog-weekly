...
![太阳能板、电网与数据中心建设现场](/images/issues/013/cover-ai-infra-editorial-v5.jpg)

封面图：太阳能板、电网与正在建设的数据中心放在同一张图里（AI 生成，模型：`openai/gpt-image-2`）。它比单纯的风景照更贴这一期的主题：AI 最后不是飘在云里的“智能感”，而是要落在真实世界的电力、土地、资本开支和建设周期上。
...
![AI 基础设施竞争不只在云里](/images/issues/013/cover-ai-infra-editorial-v5.jpg)

*太阳能、电网和数据中心放在一起，才更接近这一期的核心：AI 的竞争正在从模型能力，下沉到真实世界的供给能力。*
...
![OpenAI 把土地、电力、施工和社区协作写进基础设施叙事](/images/issues/013/news-stargate-real-v4.png)

*没有稳定供给，再好的 agent 体验也可能被价格、延迟和排队打回原形。*
...
![从芯片、云、模型到入口，AI 竞争正在变成一条供给链](/images/issues/013/weekly-stack-framework-v4.png)
...
![OpenAI Stargate 官方页面来源摘录](/images/issues/013/news-stargate-real-v4.png)
...
![browser-use 官网截图](/images/issues/013/tool-browser-use-real-v4.png)
