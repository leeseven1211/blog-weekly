...
head:
  ...
  - - meta
    - property: og:image
      content: https://blog.leeseven.com/images/issues/012/cover-workflow.svg
  - - meta
    - property: og:url
...
![AI 工作流从个人助手走向组织流程](/images/issues/012/cover-workflow.svg)

封面图：这是一张“工作流交接图”——人、权限、系统、审计，被放进同一条路径里。过去大家主要讨论 AI 能不能做事；现在更现实的问题是，它做完之后谁来确认、谁来追责、谁能接管。
...
![GPT-5.5 发布图](/images/issues/012/news-gpt55.svg)
...
![Workspace agents 工作流图](/images/issues/012/news-workspace-agents.svg)
...
![Anthropic 与 Amazon 算力合作图](/images/issues/012/news-anthropic-amazon.svg)
...
![Google Cloud Next 2026 图](/images/issues/012/news-google-next.svg)
...
![GitHub Copilot 数据政策图](/images/issues/012/news-copilot-policy.svg)
...
![Agent Governance Toolkit](/images/issues/012/tool-agent-governance.svg)
...
![Langfuse](/images/issues/012/tool-langfuse.svg)
...
![Continue](/images/issues/012/tool-continue.svg)
...
**[microsoft/spec-kit](https://github.com/microsoft/spec-kit)**

![Spec Kit](/images/issues/012/tool-spec-kit.svg)
...
![Crawl4AI](/images/issues/012/tool-crawl4ai.svg)
...
![本周判断框架图](/images/issues/012/weekly-framework.svg)

如果这一期只留下一张图，我希望是这张“四问框架”：**能不能做完、能不能解释、能不能接管、能不能退出。** 以后再看任何企业级 AI 产品，不妨先拿这四个问题过一遍。很多产品在演示时看起来都很顺，但一到真实流程里，真正决定能不能长期用下去的，往往不是第一下有多惊艳，而是第四次出错时你还能不能控制局面。
