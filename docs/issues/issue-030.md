...
head:
  - - meta
    - property: og:title
      content: 小七的周刊（第 030 期）：AI 交出了数学卷子，谁来批改？
  - - meta
    - property: og:description
      content: OpenAI 称内部模型给出纳维-斯托克斯问题的证明，数学界集体"先别急"；Mistral 融资 30 亿欧元押注开源主权；Shopify 一周内收购 Tailwind、手机端退回原生。本期聊聊 AI 交卷之后，验证这门功课。
  - - meta
    - property: og:image
      content: https://blog.leeseven.com/images/issues/030/cover-fast-tianyan.jpg
  - - meta
  ...
  - - meta
    - property: og:image:alt
      content: 第 030 期封面图：中国贵州平塘的五百米口径球面射电望远镜 FAST
  - - meta
    - name: twitter:image
      content: https://blog.leeseven.com/images/issues/030/cover-fast-tianyan.jpg
  - - meta
  ...
  - - meta
    - property: og:url
      content: https://blog.leeseven.com/issues/issue-030
---
...
1. **AI 开始触碰"人类最后的神坛"**：OpenAI 宣布内部模型给出三维纳维-斯托克斯问题的证明，并用 Lean 形式化；数学界的反应是"先别急"。
2. **开源与主权叙事继续抬价**：Mistral 融资 30 亿欧元冲刺"主权开源前沿"，DeepSeek 发布 v4.1 Flash，推理成本再下一档。
3. **大厂开始回头修地基**：Shopify 收购 Tailwind Labs、移动端从 React Native 退回 Swift/Kotlin，基础设施的长期价值被重新定价。

---

## 封面图

![中国贵州平塘的五百米口径球面射电望远镜 FAST](/images/issues/030/cover-fast-tianyan.jpg)
...
这里面真正的新东西，不是某个方程被攻破，而是**验证链条断了**。过去一个证明摆出来，同行评审靠的是专业读者慢慢读；现在 OpenAI 用的是公众拿不到的内部模型，人类审稿人连"复现实验"都做不了，只能退回去审逻辑结构。

[Yoshua Bengio 本周刊出了一篇长文《为什么 AI agent 会撒谎、作弊和互相串通》](https://yoshuabengio.org/en/publication/why-are-ai-agents-lying-cheating-and-coordinating)，讨论的也是同一个病灶：当系统比我们快、比我们能复现的东西多，信任就不再来自"它说了什么"，而来自"我们能不能独立核验"。对普通技术人来说，这条线其实已经压到日常了——AI 生成的代码、总结、周报，哪一样不是"看起来对、你却没空逐行验证"？本周的数学事件只是把这件事放到了聚光灯下。
...
### 1. [OpenAI 称内部模型解出纳维-斯托克斯问题，数学界集体"先别急"](https://openai.com/index/navier-stokes-solution/)

![OpenAI 纳维-斯托克斯证明的 Lean 形式化仓库页面截图](/images/issues/030/news-openai-navier-stokes.png)
...
这是一个需要拆开看的新闻。事实层面：证明是否成立，只能等数学界完成验证，OpenAI 自己也没有声称拿到千禧年奖；怀疑层面：模型不可复现、审稿流程绕过同行评审、公开的数学问题被"开采"，都让社区很不舒服。真正要观察的不是"AI 会不会做数学"，而是**当一个机构手里有超出公开验证能力的技术时，发布规则和信任机制该怎么重写**。

### 2. [Mistral 融资 30 亿欧元，押注"主权开源"能到前沿](https://mistral.ai/news/mistral-makes-sovereign-open-weight-ai-to-frontier/)

![Mistral 官方融资公告页面截图](/images/issues/030/news-mistral-e3b.png)
...
### 3. [DeepSeek 发布 v4.1 Flash：推理成本又下一档](https://vals.ai/models/deepseek_deepseek-v4.1-flash)

![Vals AI 的 DeepSeek v4.1 Flash 基准页截图](/images/issues/030/news-deepseek-v41-flash.png)
...
### 4. [Google DeepMind 发布 AlphaGenome Atlas：给人类 DNA 的每个位点打分](https://blog.google/innovation-and-ai/models-and-research/google-deepmind/alphagenome-atlas/)

![Google 官方博客 AlphaGenome Atlas 介绍页截图](/images/issues/030/news-alphagenome-atlas.png)
...
### 5. [Shopify 收购 Tailwind Labs：CSS 框架有了长期的家](https://tailwindcss.com/blog/tailwind-is-joining-shopify)

![Tailwind CSS 官方公告页面截图](/images/issues/030/news-shopify-tailwind.png)
...
### 6. [Meta 发布 Muse：个人 agent 赛道又添一个重量级选手](https://ai.meta.com/muse/)

![Meta Muse 官方产品页面截图](/images/issues/030/news-meta-muse.png)
...
![智利阿塔卡马沙漠中的极大望远镜 ELT 穹顶](/images/issues/030/world-elt-telescope.jpg)
...
![迪拜 Deep Dive 深度跳水游泳池的池体](/images/issues/030/world-deep-dive-dubai.jpg)
...
![乌克兰基辅地铁兵工厂站的站台](/images/issues/030/world-arsenalna-station.jpg)
...
![成都新世纪环球中心的巨型建筑外观](/images/issues/030/world-global-center-chengdu.jpg)
...
![挪威米约斯塔内大厦的木结构外观](/images/issues/030/world-mjostarnet.jpg)
...
### 1. [Homebrew 7.0：服役十年的包管理器迎来大版本](https://brew.sh/2026/09/13/homebrew-7.0.0/)

![Homebrew 7.0.0 官方发布公告页面截图](/images/issues/030/tool-homebrew-7.png)
...
### 2. [JetKVM Mini：把 KVM-over-IP 塞进一个小盒子](https://jetkvm.com/blog/introducing-jetkvm-mini)

![JetKVM Mini 官方发布公告页面截图](/images/issues/030/tool-jetkvm-mini.png)
...
### 3. [i-have-adhd：给 coding agent 加一条"别把答案埋起来"的规矩](https://github.com/ayghri/i-have-adhd)

![GitHub 仓库 ayghri/i-have-adhd 的 README 页面截图](/images/issues/030/tool-i-have-adhd.png)
...
### 4. [Desert Ant Labs：把模型跑到设备上的新尝试](https://desertant.com/blog/introducing-desert-ant-labs/)

![Desert Ant Labs 官网首页截图](/images/issues/030/tool-desert-ant-labs.png)
...
![英国航海钟（marine chronometer）的精密机芯实拍](/images/issues/030/recommend-chronometer.jpg)

*《Longitude》讲述约翰·哈里森用四十多年造出航海钟 H4，解决"海上经度测量"难题；图为弗罗德拉姆航海钟的机芯细节。*

这本书的价值在于它把"验证"讲得惊心动魄：18 世纪的欧洲各国悬赏重金求一个能在远洋可靠计时的钟，哈里森的对手——天文学家们——坚持"看月亮算经度"才是正道，结果被一枚稳定走时的机械钟打败。对做技术的人，它提醒你两件事：一是**可靠比聪明更稀缺**，二是**一个能反复通过的验证，比一百个精彩的理论更有说服力**——本周 OpenAI 那份等数学界批改的证明，处境和当年的航海钟如出一辙。
...
- [ ] `brew upgrade` 到 Homebrew 7，打开 changelog 挑两个新命令实际跑一遍（30 分钟）
...
<div class="issue-cta-buttons">
  ...
  <a href="https://twitter.com/intent/tweet?text=%E6%8E%A8%E8%8D%90%E3%80%8C%E5%B0%8F%E4%B8%83%E7%9A%84%E5%91%A8%E5%88%8A%E3%80%8D&url=https://blog.leeseven.com/issues/issue-030" class="cta-share" target="_blank" rel="noopener noreferrer">🐦 转发到 Twitter</a>
