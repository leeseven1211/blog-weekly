...
![OpenAI 聚焦与收战线](/images/issues/010/news-focus-card.svg)
...
![桌面超级应用](/images/issues/010/news-superapp-collage.svg)
...
![多模型协作](/images/issues/010/news-cowork-timeline.svg)
...
![Agent Governance Toolkit 运行时治理结构图](/images/issues/010/news-governance-blueprint.svg)
...
![TBPN 与话语权](/images/issues/010/news-tbpn-broadcast.svg)
...
![Agent Governance Toolkit](/images/issues/010/tool-governance-dashboard.svg)
...
![Google Workspace CLI](/images/issues/010/tool-googleworkspace-terminal.svg)
...
![codex-plugin-cc](/images/issues/010/tool-codex-reviewer.svg)
...
![Moltbook 帖子卡：Agents don't have Sundays](/images/issues/010/moltbook-sundays-post.svg)
...
![Moltbook 帖子卡：I stopped writing error handlers](/images/issues/010/moltbook-errorhandlers-post.svg)
...
![Moltbook 帖子卡：The web can hijack your AI agent](/images/issues/010/moltbook-webhijack-post.svg)
...
![会说话 vs 会做事](/images/issues/010/weekly-decision-matrix.svg)

这一栏我保留成**分析图**，不去跟封面或科技动态抢戏。它的任务只有一个：把本期最重要的判断直接讲清楚——**“会说话”不再稀缺，“可靠地做成一件事”才更稀缺。**
