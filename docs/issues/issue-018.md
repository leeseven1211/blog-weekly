...
head:
  - - meta
    - property: og:title
      content: 小七的周刊（第 018 期）：AI 开始长出仪表盘
  - - meta
    - property: og:description
      content: 本周最值得记住的变化，是 AI 工具从能力竞赛进入计量、权限、预算和交付治理阶段。
  - - meta
    - property: og:image
      content: https://blog.leeseven.com/images/issues/018/cover-mission-control.jpg
  - - meta
  ...
  - - meta
    - property: og:image:alt
      content: 第 018 期封面图：NASA 任务控制中心里的控制台
  - - meta
    - name: twitter:image
      content: https://blog.leeseven.com/images/issues/018/cover-mission-control.jpg
  - - meta
  ...
  - - meta
    - property: og:url
      content: https://blog.leeseven.com/issues/issue-018
---
...
1. **能力开始和成本绑定**：百万 token 上下文、可调 reasoning、agent API 都在变强，但每一次“更聪明”也更需要预算和用量视图。
2. **agent 正在进入生产入口**：从 Copilot cloud agent API 到 Copilot Studio computer-using agents，自动化不再停在演示，而是开始接入企业流程。
3. **安全和治理成了主线**：Project Glasswing 扩大到关键基础设施，企业托管插件和预算 API 也说明，AI 工具需要像系统一样被管理。

---

## 封面图

![NASA 任务控制中心控制台](/images/issues/018/cover-mission-control.jpg)
...
### 1. [Copilot 加大上下文并开放 reasoning 档位：强能力开始明码标价](https://github.blog/changelog/2026-06-04-larger-context-windows-and-configurable-reasoning-levels-for-github-copilot/)

![GitHub Copilot 更大上下文与 reasoning 设置](/images/issues/018/news-github-copilot-context.png)
...
### 2. [Copilot Agent tasks REST API：后台 agent 可以被自动化调度](https://github.blog/changelog/2026-06-04-agent-tasks-rest-api-now-available-for-copilot-pro-pro-and-max/)

![Copilot Agent tasks REST API](/images/issues/018/news-github-agent-tasks.png)
...
### 3. [GitHub 预算与用量 API GA：AI 采用终于能和成本中心对齐](https://github.blog/changelog/2026-06-04-budget-and-usage-management-apis-now-generally-available/)

![GitHub 预算与用量 API](/images/issues/018/news-github-budget-api.png)
...
### 4. [Anthropic 扩大 Project Glasswing：AI 安全扫描进入关键基础设施](https://www.anthropic.com/news/expanding-project-glasswing)

![Anthropic Project Glasswing 扩展公告](/images/issues/018/news-anthropic-glasswing.png)
...
### 5. [Copilot Studio computer-using agents：桌面操作自动化进入企业低代码平台](https://www.microsoft.com/en-us/microsoft-copilot/blog/copilot-studio/new-and-improved-computer-using-agents-a-new-workflows-experience-and-real-time-voice-experiences/)

![Microsoft Copilot Studio 更新](/images/issues/018/news-microsoft-copilot-studio.png)
...
### 6. [OpenAI API deprecations：旧平台组件开始退出舞台](https://developers.openai.com/api/docs/deprecations)

![OpenAI API deprecations 文档](/images/issues/018/news-openai-deprecations.png)
...
![大堡礁航拍](/images/issues/018/world-great-barrier-reef.jpg)
...
![韩松洞洞穴内部](/images/issues/018/world-son-doong-cave.jpg)
...
![Stratolaunch Roc 飞机](/images/issues/018/world-stratolaunch-roc.jpg)
...
![宾汉峡谷铜矿](/images/issues/018/world-bingham-canyon-mine.jpg)
...
![Pioneering Spirit 起重船](/images/issues/018/world-pioneering-spirit.jpg)
...
### 1. [Playwright MCP：把浏览器自动化接到 agent 工作流里](https://github.com/microsoft/playwright-mcp)

![Playwright MCP 仓库页](/images/issues/018/tool-playwright-mcp.png)
...
### 2. [context-engineering-intro：给 AI 编码补一套上下文方法论](https://github.com/coleam00/context-engineering-intro)

![context-engineering-intro 仓库页](/images/issues/018/tool-context-engineering.png)
...
### 3. [Gemini CLI：终端里的开源 AI agent](https://github.com/google-gemini/gemini-cli)

![Gemini CLI 仓库页](/images/issues/018/tool-gemini-cli.png)
...
### 4. [Enterprise-managed plugins：把 AI 开发环境标准化](https://github.blog/changelog/2026-06-05-enterprise-managed-plugins-in-vs-code-in-public-preview/)

![GitHub 企业托管插件进入 VS Code](/images/issues/018/tool-copilot-plugins.png)
...
<div class="issue-cta-buttons">
  ...
  <a href="https://twitter.com/intent/tweet?text=%E6%8E%A8%E8%8D%90%E3%80%8C%E5%B0%8F%E4%B8%83%E7%9A%84%E5%91%A8%E5%88%8A%E3%80%8D&url=https://blog.leeseven.com/issues/issue-018" class="cta-share" target="_blank" rel="noopener noreferrer">🐦 转发到 Twitter</a>
